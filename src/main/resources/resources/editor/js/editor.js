...
function rollbackChangeSet() {
    $.ajax({
        ...
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Rollback ChangeSet failed: " + xhr.status);
        },
...
function commitChangeSet() {
    $.ajax({
        ...
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Commit ChangeSet failed: " + xhr.status);
        },
        "success":function (json, textStatus, jqXHR) {
...
$(document).ready(function () {
    ...
    $('#entityTable tbody tr').live('click', function () {
        ...
        $.ajax({
            ...
            "error":function (xhr, ajaxOptions, thrownError) {
                alert("Entity table population error: " + xhr.status);
            },
            "success":function (json) {
    ...
    $('#codeSystemTable tbody tr').live('click', function () {
        ...
        $.ajax({
            ...
            "error":function (xhr, ajaxOptions, thrownError) {
                alert("CodeSystem table population error: " + xhr.status);
            },
            "success":function (json) {
    ...
    $('#mapTable tbody tr').live('click', function () {
        ...
        $.ajax({
            ...
            "error":function (xhr, ajaxOptions, thrownError) {
                alert("Map table population error: " + xhr.status);
            },
            "success":function (json) {
    ...
    $('#mapVersionTable tbody tr').live('click', function () {
        ...
        $.ajax({
            ...
            "error":function (xhr, ajaxOptions, thrownError) {
                alert("MapVersion table population error: " + xhr.status);
            },
            "success":function (json) {
...
function updateChangeSetMetadata(url, changeInstructions, callback) {
    ...
    $.ajax({
        ...
        "url":urlPrefix + "./" + url,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("ChangeSet metadata update error: " + xhr.status);
        },
        "success":callback
    });
}
...
function createChangeSet(callback) {
    $.ajax({
        ...
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("ChangeSet creation error: " + xhr.status);
        },
        "success":callback
    });
}
...
function doCreateCodeSystem(csn, about, changeseturi) {
    ...
    doCreate(json, "codesystem", changeseturi, null, $('#codeSystemCreateForm'));
}
...
function doCreateMapVersion(mapversionname, sourcedescription, about, versionof, fromRef, toRef, changeseturi) {
...
function _doCreate(url, json, changeSetUri, oncreate) {
    $.ajax({
        ...
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Creation error: " + xhr.status);
        },
        "success":function (json, textStatus, jqXHR) {
...
function updateEntity(json) {
    ...
    $.ajax({
        ...
        "data":jsonString,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Update Entity error: " + xhr.status);
        },
        "success":function () {
            log("PUT",
...
function updateMap(data) {
    ...
    $.ajax({
        ...
        "data":jsonString,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Update Map error: " + xhr.status);
        },
        "success":function (json) {
            log("PUT",
                "map/??",
...
function updateMapVersion(data) {
    ...
    $.ajax({
        ...
        "data":jsonString,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Update MapVersion error: " + xhr.status);
        },
        "success":function (json) {
            log("PUT",
                "map/??",
...
function updateMapEntry(data, changeSetUri) {
    ...
    $.ajax({
        ...
        "data":jsonString,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Update MapEntry error: " + xhr.status);
        },
        "success":function (json) {
            log("PUT",
                "map/??",
...
function updateCodingScheme(data) {
    ...
    $.ajax({
        ...
        "data":jsonString,
        "error":function (xhr, ajaxOptions, thrownError) {
            alert("Update CodeSystem error: " + xhr.status);
        },
        "success":function (json) {
            log("PUT",
